---
title: "z_tests_examples"
output: pdf_document
date: "2026-04-02"
---


Let's do some z-tests!! You should have been assigned one of X numbers. Please focus on doing that problem. Be sure to run the code immediately below the instructions (line 15-ish)
...
Did you you know there are earthquakes near Fiji? Over 5000 were recorded since 1964. Using the data set below, test the claim that the average magnitude of the earthquakes are below 5. Assume the variance is .15 unites. 
...
Below is the quarterly earnings for the Johnson and Johnson company from 1960 to 1980. Please run a z-test to see if the average quarterly earnings per share is different than $10. Assume the variance is 20
...
3) Run a z-test to see if the observed volume is the same as your estimated volume 
...
Below is data collected in New Haven Conn. (admittedly not midwestern) from 1912 to 1971 where each data point is the average temp in a year. Use this to run a z-test to test if the above. Assume the variance is 2
...
Sunspots measured for each month. Please run a t-test to see if the mean is 100 or not 100 Assume a variance of 5000.
