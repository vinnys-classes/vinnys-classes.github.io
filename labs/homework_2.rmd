...
### Q17
Using log(amazon_price) as the response variable and pieces as the x-axis, fit a linear regression model. Plot the residuals similar to question 7 with your residuals as the y-axis and the predicted values on the x-axis. Comment if the normality and homoskedasiticity assumptions are met.
...
Create a residual graph for the model created in Q19 and comment on whether the normality and homoskedasiticity assumptions are met.
