...
* **How** -- How was the experiment ran? How was the data physically collected? 
...
**Question 2:** Comment on whether you believe that distribution is representative of the class and the college in general. Then, go skim the help page for HairEyeColor (it is a data set that comes with R, but, despite not being a function, it has it's own help page). Comment on any piece of information presented about the data that would be relevant to any possible discrepancies.
