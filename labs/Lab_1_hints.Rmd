...
You'll want to run the lines of code before which installs a way to make markdown render (tinytex), help with data cleaning (dplyr), and make graphs (ggplot2)
```{r}
