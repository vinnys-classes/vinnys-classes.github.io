...
### Question 5
Let's go back to the scatterplot idea from Quesiton 2. Please remake that graph (feel free to copy and paste) but this time add **just** color to the graph. 
...
### Question 7
Using any of the graphs made so far (with strong preferrence to the scatterplot), please describe the relationship between years and flow rate. You do not need to discuss the change point; I'm wanting you to practice describing a scatterplot. Mention the form, direction, strength, and outliers please.
...
ggplot(data = my_nile,
  ...
  labs(title = 'A Graph about a River', #Main title
       ...
       linetype = 'My color and lines') #color and linetype; both of these need the same name otherwise R will make two legends!!
```
...
### Question 14
Copy the graph made above in question 13 and change the side the tilda (the squiggly line) is on from the left side of the "changepoint" variable to the right side. Rerun the graph and comment on what changed. 
