...
Participation in a lab-heavy course is needed. During labs you are expected to help your partner(s) learn the material (which goes beyond simply answering the lab questions), and they are expected to help you. There is no formal attendance; I recognize you are adults and are capable of making your own decisions. I cannot stress enough though how important the act of showing up to the classroom is for you academic success, in this course and in later in life. I won't claim causality, but there is definitely a correlation.
...
All labs are worth 5 points, and will be due at 5:00pm two days after we are no longer working on it in class, but my goal is for everyone to have them finished before class is over. Your two lowest lab scores will be dropped (which includes the possibility of dropping 0's).
...
Homework will be assigned regularly. Absolutely no late homework will be graded, but your lowest two scores will be dropped (which can include 0's). Please note that you will still recieve feedback/commentary on your homework, just not a grade. Homework will be due on Canvas, generally due 5pm on Tuesdays. 
...
Please do not ask for an extension as you will not be given one and, more so, it's emotionally draining on me. 
...
|8| Confidence Intervals and Hypothesis test for means|
|9| Confidence Intervals and Hypothesis test for means|
|10|ANOVA|
...
|15| \chi^2 tests and Logisitic Regression
||Final|
